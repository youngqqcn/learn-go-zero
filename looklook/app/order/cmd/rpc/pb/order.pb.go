...
type HomestayOrder struct {
	...
	TradeCode           int64  `protobuf:"varint,21,opt,name=tradeCode,proto3" json:"tradeCode,omitempty"`
	Remark              string `protobuf:"bytes,22,opt,name=remark,proto3" json:"remark,omitempty"`
	OrderTotalPrice     string `protobuf:"bytes,23,opt,name=orderTotalPrice,proto3" json:"orderTotalPrice,omitempty"`
	FoodTotalPrice      string `protobuf:"bytes,24,opt,name=foodTotalPrice,proto3" json:"foodTotalPrice,omitempty"`
...
func (x *HomestayOrder) GetTradeCode() int64 {
	if x != nil {
		return x.TradeCode
	}
	return 0
...
func (x *HomestayOrder) GetOrderTotalPrice() string {
	if x != nil {
...
func (x *HomestayOrder) GetFoodTotalPrice() string {
	if x != nil {
...
var file_order_proto_rawDesc = []byte{
	...
	0x18, 0x15, 0x20, 0x01, 0x28, 0x03, 0x52, 0x09, 0x74, 0x72, 0x61, 0x64, 0x65, 0x43, 0x6f, 0x64,
	...
	0x28, 0x09, 0x52, 0x0f, 0x6f, 0x72, 0x64, 0x65, 0x72, 0x54, 0x6f, 0x74, 0x61, 0x6c, 0x50, 0x72,
	0x69, 0x63, 0x65, 0x12, 0x26, 0x0a, 0x0e, 0x66, 0x6f, 0x6f, 0x64, 0x54, 0x6f, 0x74, 0x61, 0x6c,
	0x50, 0x72, 0x69, 0x63, 0x65, 0x18, 0x18, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0e, 0x66, 0x6f, 0x6f,
